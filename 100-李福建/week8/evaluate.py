...
class Evaluator:
    ...
    def knwb_to_vector(self):
        ...
        return self.knwb_vectors, self.question_index_to_standard_question_index
...
def all_knwb_to_vector(config, model, logger):
    ev = Evaluator(config, model, logger)
    return ev.knwb_to_vector()
