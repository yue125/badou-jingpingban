...
bert = BertModel.from_pretrained(r"D:\BaiduNetdiskDownload\bert-base-chinese", return_dict=False)
...
class DiyBert:
    ...
    def self_attention(self,
        ...
        qk = np.matmul(q, k.swapaxes(1, 2)) # matmul矩阵乘法 -> (12, 4, 4)
        ...
        qkv = qkv.swapaxes(0, 1).reshape(-1, hidden_size) # multi-heads合并回初始输入的(4, 768)
    ...
    def transpose_for_scores(self, x, attention_head_size, num_attention_heads):
        ...
        # 一开始是4 * 768的数据 最后转为 12 * 4 * 64的数据即12份4 * 64
