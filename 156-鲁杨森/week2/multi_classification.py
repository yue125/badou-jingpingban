...
五维判断：x是一个5维向量，向量中哪个标量最小就输出哪一维下标
...
if __name__ == "__main__":
    main()
    test_vec = [[0.67889086, 0.16299675, 0.31082123, 0.1350317, 0.18924843],
                [0.84963533, 0.55875856, 0.15758807, 0.95520434, 0.84890681],
                [0.77777868, 0.67482528, 0.13625847, 0.34675372, 0.09871392],
                [0.96949776, 0.59416669, 0.97579291, 0.41567412, 0.7359894]]
