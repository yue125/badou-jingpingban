...
class TorchModel(nn.Module):
    def __init__(self, vector_dim, sentence_length, vocab):
        ...
        self.rnn = nn.RNN(vector_dim, vector_dim, batch_first=True) # https://pytorch.org/docs/stable/generated/torch.nn.RNN.html
        self.classify = nn.Linear(vector_dim, sentence_length + 1)     #线性层
        # self.activation = torch.softmax    #归一化函数
...
def evaluate(model, vocab, sample_length):
    ...
    print("evaluate x set: ", x)
    print("evaluate y set: ", y)
